...
another thread. There is also some syntactic sugar to work with `Result` types, 
which closely resembles the monadic error handling known from Haskell and other 
