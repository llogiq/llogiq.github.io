...
Veedrac also [improved](https://github.com/TeXitoi/benchmarksgame-rs/pull/24) the `chameneos_redux` benchmark (the work on this appears to be ongoing), and I hope he'll be able to write about it soon.
