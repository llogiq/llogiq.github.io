...
This post is based on my [RustNationUK '24](https://rustnationuk.com) talk with the same title. The talk is available [on YouTube](https://www.youtube.com/watch?v=33FG6O3qejM), and the slides are online [here](/talks/easy.html).
